...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public void addChildrenForAccessibility(ArrayList<View> childrenForAccessibility) {
        ...
        } catch (Exception e) {//try to the HuaweiCh1-Cl10 crash. the error link :http://www.umeng.com/apps/cda000350ea55f0eaaf67355/error_types/568871af498ebb3e35df56ca
            e.printStackTrace();
        }
    }
     ...
     * 可刷新View的包装布局
     */
    private RelativeLayout mRefreshableViewWrapper;
    ...
    protected void addRefreshableView(Context context, T refreshableView) {
        ...
        // 创建一个包装容器
        mRefreshableViewWrapper = new RelativeLayout(context);
    ...
    /***
     * 这里定义一些方向，使基类具有通用的一些能力，方便子类重写调用
     */
