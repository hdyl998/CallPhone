...
public class RxPermissions {
    ...
    public Observable<List<Permission>> requestListPermissons(final String... permissions) {
        return Observable.just(null).compose(ensureListPermissions(permissions));
    }

    public Observable.Transformer<Object, List<Permission>> ensureListPermissions(final String... permissions) {
        return new Observable.Transformer<Object, List<Permission>>() {
            @Override
            public Observable<List<Permission>> call(Observable<Object> o) {
                return request(o, permissions)
                        // Transform Observable<Permission> to Observable<Boolean>
                        .buffer(permissions.length)
